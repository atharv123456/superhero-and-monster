...
var engine, world;
var box1, box2, box3,box4,box5,box6,box7,box8,box9,box10,box11,box12,box13,box14,box15,box16,box18,box19,box20,box21;
...
function draw() {
  ...
  textSize(22);
  fill("black");
  text("Drag Your Mouse To Move The SuperHero To Hit The Monster",100,20);
  ground.display();
  box1.display();
  box2.display();
  box3.display();
